...
#define GPFCON_GPF0_CONF_START		(GPIOCON_PIN0_START_BIT	)
#define GPFCON_GPF1_CONF_START 		(GPIOCON_PIN1_START_BIT )
#define GPFCON_GPF2_CONF_START 		(GPIOCON_PIN2_START_BIT )
#define GPFCON_GPF3_CONF_START 		(GPIOCON_PIN3_START_BIT )
#define GPFCON_GPF4_CONF_START 		(GPIOCON_PIN4_START_BIT )
#define GPFCON_GPF5_CONF_START 		(GPIOCON_PIN5_START_BIT )
#define GPFCON_GPF6_CONF_START 		(GPIOCON_PIN6_START_BIT )
#define GPFCON_GPF7_CONF_START 		(GPIOCON_PIN7_START_BIT )
#define GPFCON_GPF8_CONF_START		(GPIOCON_PIN8_START_BIT	)
#define GPFCON_GPF9_CONF_START 		(GPIOCON_PIN9_START_BIT )
#define GPFCON_GPF10_CONF_START 	(GPIOCON_PIN10_START_BIT)
#define GPFCON_GPF11_CONF_START 	(GPIOCON_PIN11_START_BIT)
#define GPFCON_GPF12_CONF_START 	(GPIOCON_PIN12_START_BIT)
#define GPFCON_GPF13_CONF_START 	(GPIOCON_PIN13_START_BIT)
#define GPFCON_GPF14_CONF_START 	(GPIOCON_PIN14_START_BIT)
#define GPFCON_GPF15_CONF_START 	(GPIOCON_PIN15_START_BIT)
...
#define GPGCON_GPG5_SPIMISO1		GPIOCON_PIN_CONF_VAL_3
#define GPGCON_GPG6_SPIMOSI1		GPIOCON_PIN_CONF_VAL_3
#define GPGCON_GPG7_SPICLK1			GPIOCON_PIN_CONF_VAL_3
