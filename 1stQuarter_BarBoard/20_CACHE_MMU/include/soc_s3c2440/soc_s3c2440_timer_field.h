...
#define TCFG0_PRESCALER0_MASK			(0xFF)		/* These 8 bits determine prescaler value for Timer 0 and 1. */
#define TCFG0_PRESCALER_MASK			(0xFF)		/* These 8 bits determine prescaler value for Timer 2, 3 and 4. */
#define TCFG0_DEAD_ZONE_LEN_MASK		(0xFF)
#define TCFG0_RESERVED_MASK				(0xFF)
 ...
 * 01xx = External TCLKn
 */
#define TCFG1_MUX0_MASK				(0xF)		/* Select MUX input for PWM Timer0. */
#define TCFG1_MUX1_MASK				(0xF)		/* Select MUX input for PWM Timer1. */
#define TCFG1_MUX2_MASK				(0xF)		/* Select MUX input for PWM Timer2. */
#define TCFG1_MUX3_MASK				(0xF)		/* Select MUX input for PWM Timer3. */
#define TCFG1_MUX4_MASK				(0xFF)		/* Select MUX input for PWM Timer4. */
...
#define TCON_TIMER0_MASK				(0XF)
#define TCON_TIMER1_MASK				(0XF)
#define TCON_TIMER2_MASK				(0XF)
#define TCON_TIMER3_MASK				(0XF)
#define TCON_TIMER4_MASK				(0X7)
