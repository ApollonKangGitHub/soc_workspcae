...
void timer_0_init(void)
{
	...
	/* prescaler 0 = 49 */
	SOC_S3C2440_REG_BITS_SET(TCFG0r, TCFG0_PRESCALER0_START_BIT, TCFG0_PRESCALER0_MASK, 49);
	
	/* MUX0 = 1/16 */
	SOC_S3C2440_REG_BITS_SET(TCFG1r, TCFG1_MUX0_START_BIT, TCFG1_MUX0_MASK, TCFG1_MUX_PWM_1_16);	
