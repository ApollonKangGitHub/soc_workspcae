...
static lcd_controller_type_t gLcdControllerType = lcd_controller_max;
...
static lcd_controller_type_t lcd_controller_drv_type(void)
{
	...
	if (gLcdControllerType != lcd_controller_max)
	{
		type = gLcdControllerType;
	}
